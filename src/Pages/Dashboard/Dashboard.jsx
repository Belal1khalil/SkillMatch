  ...
  const opportunities = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1542744094-24638eff58bb?auto=format&fit=crop&q=80&w=400",
      isTrending: true,
    },
    {
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-16">
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-lg font-medium opacity-80">
              Your dashboard is looking great. You have 3 new matching jobs!
            </p>
          </div>
          ...
          <div className="bg-white p-2 rounded-[2.25rem] border border-gray-100 shadow-xl shadow-gray-200/40 flex items-center gap-1 max-w-sm animate-subtle-pulse group cursor-pointer hover:shadow-2xl transition-all">
            ...
            <button className="w-12 h-12 bg-primary-600 text-white rounded-2xl flex items-center justify-center hover:bg-primary-700 transition-all shadow-lg shadow-primary-500/20 m-1">
               <Link to="/profile">
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-2">
              ...
              <button className="p-2.5 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-all shadow-md shadow-primary-500/20">
            ...
            {opportunities.map((op, index) => (
              ...
              >
                <div className="h-56 overflow-hidden relative">
                  ...
                  {op.isTrending && (
                    <div className="absolute top-4 left-4 px-3 py-1.5 bg-amber-400 text-amber-950 text-[10px] font-black uppercase tracking-wider rounded-lg flex items-center gap-1.5 shadow-lg">
                      <FontAwesomeIcon icon={faFire} className="text-[11px]" />
                      Trending
                    </div>
                  )}
                  {op.isNew && (
                ...
                <div className="p-8 flex-1 flex flex-col">
                  <div className="mb-6 flex-1">
                    <h4 className="text-lg font-black text-gray-900 mb-1 group-hover:text-primary-600 transition-colors uppercase tracking-tight leading-tight">
                      {op.title}
                    </h4>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {op.tags.map((tag, i) => (
                        <span
                          key={i}
                          className="px-3 py-1.5 bg-gray-50 text-gray-500 text-[9px] font-black uppercase tracking-widest rounded-xl border border-gray-100/50"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <button className="w-full py-4 bg-gray-900 text-white text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-primary-600 hover:shadow-xl hover:shadow-primary-600/20 transition-all active:scale-95">
