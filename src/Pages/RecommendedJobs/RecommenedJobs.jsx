...
import { GetRecommendedJobs } from "../../services/opportunities-services";
...
export default function RecommenedJobs() {
  ...
  const fetchRecommendedJobs = async () => {
    ...
    try {
      ...
      if (response.success) {
        setJobs(response.data?.data?.recommendedOpportunities || []);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 font-sans pb-16">
      ...
      {/* Hero Header */}
      <div className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-indigo-800 text-white pt-24 pb-48 px-6 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-12">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight leading-[1.1]">
                ...
                <span className="text-amber-400">Perfectly Matched.</span>
              </h1>
              <p className="text-primary-100 text-lg font-medium max-w-lg leading-relaxed opacity-90">
                We've analyzed your skills and profile to find these exclusive opportunities tailored just for you.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-32 relative z-20">
        <div className="flex items-center justify-between mb-8 text-white ">
          <div>
            ...
            <p className="text-xs font-bold opacity-70 mt-1 ml-13">Based on your expertise in React & Figma</p>
          </div>
        ...
        {loading ? (
            ...
            {filteredJobs.map((job, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  ...
                  <button className="w-10 h-10 bg-gray-50 text-gray-300 hover:text-primary-500 transition-colors rounded-xl flex items-center justify-center">
                ...
                <div className="flex-1 relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-2.5 text-gray-500">
                      ...
                      <span className="text-xs font-bold">{job.salary || '$80k - $120k'}</span>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-[4rem] p-20 text-center border border-gray-100 shadow-xl shadow-gray-200/30">
            ...
            <p className="text-gray-400 font-bold max-w-sm mx-auto mb-10 leading-relaxed">
              We couldn't find any jobs matching "{searchQuery}". Try adjusting your search or updating your profile skills.
            </p>
            <button 
        ...
        <div className="max-w-7xl mx-auto px-6 mt-20">
          <div className="bg-white rounded-[3rem] p-12 border border-gray-100 flex flex-col md:flex-row items-center justify-around gap-12 shadow-sm">
             <div className="text-center group">
                ...
                <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest">Available Matches</p>
             </div>
             <div className="w-px h-12 bg-gray-100 hidden md:block"></div>
             <div className="text-center group">
                <p className="text-4xl font-black text-indigo-600 mb-1 group-hover:scale-110 transition-transform">95%</p>
                <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest">Average Match Score</p>
             </div>
             <div className="w-px h-12 bg-gray-100 hidden md:block"></div>
             <div className="text-center group">
                <p className="text-4xl font-black text-emerald-600 mb-1 group-hover:scale-110 transition-transform">24h</p>
                <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest">Avg. Response Time</p>
             </div>
          </div>
        </div>
      )}
